...
def estimate_pose(mask_lgts: torch.tensor, query_img: torch.tensor,
    ...
    """
    Builds correspondence distribution from queries and keys, 查询和key建立对应关系
    samples correspondences with inversion sampling, 反转抽样
    samples poses from correspondences with P3P, 从采样的对应关系估计姿态
    prunes pose hypothesis, 对姿态假设剪枝
    and scores pose hypotheses based on estimated mask and correspondence distribution. #对姿态评分
