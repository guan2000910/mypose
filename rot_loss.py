...
def angular_distance(r1, r2, reduction="mean"): #计算旋转角度距离，处理四元数和旋转矩阵两种输入
...
def angular_distance_rot(m1, m2, reduction="mean"): #两个旋转矩阵之间的角度距离
...
if __name__ == "__main__":
    ...
    from surfemb.transform import random_quaternion
