...
class SurfaceSampleAux(BopInstanceAux): #物体表面采样 传入：物体对象和采样点数量 
...
class MaskSamplesAux(BopInstanceAux): #从可见掩膜中采样 传入采样带你数量和掩膜key
